...
import { filterRibbons, gen3ContestRibbonsFromBytes, gen3ContestRibbonsToBytes, } from '../util/ribbonLogic';
...
export default class XDPKM {
    ...
    constructor(arg) {
        if (arg instanceof ArrayBuffer) {
            ...
            this.ribbons = gen3ContestRibbonsFromBytes(dataView, 0xb3).concat(byteLogic.getFlagIndexes(dataView, 0x7c, 15, 12).map((index) => Gen3StandardRibbons[index]));
        }
        else {
            const other = arg;
    ...
    toBytes() {
        ...
        byteLogic.setFlagIndexes(dataView, 0x7c, 15, this.ribbons
