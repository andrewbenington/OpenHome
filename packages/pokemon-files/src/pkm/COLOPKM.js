...
export default class COLOPKM {
    ...
    constructor(arg) {
        if (arg instanceof ArrayBuffer) {
            ...
            this.ribbons = gen3ContestRibbonsFromBytes(dataView, 0xb7).concat(byteLogic.getByteIndexes(dataView, 0xbd, 11).map((index) => Gen3StandardRibbons[index]));
        }
        else {
            const other = arg;
    ...
    toBytes() {
        ...
        byteLogic.setByteIndexes(dataView, 0xbd, this.ribbons
