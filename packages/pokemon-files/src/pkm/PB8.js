...
export default class PB8 {
    ...
    eggDate;
    metDate;
    eggLocationIndexInternal = 0xffff;
    metLocationIndex;
    ball;
    metLevel;
    tmFlagsBDSP;
    ...
    constructor(arg, encrypted) {
        if (arg instanceof ArrayBuffer) {
            ...
            this.ribbons = byteLogic
                ...
                .concat(byteLogic.getFlagIndexes(dataView, 0x40, 0, 47).map((index) => ModernRibbons[index + 64]));
    ...
    toBytes() {
        ...
        byteLogic.setFlagIndexes(dataView, 0x34, 0, this.ribbons
            .map((ribbon) => ModernRibbons.indexOf(ribbon))
            .filter((index) => index > -1 && index < 64));
        byteLogic.setFlagIndexes(dataView, 0x40, 0, this.ribbons
