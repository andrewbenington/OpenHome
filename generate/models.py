...
class PokemonForm(SimplePokemonForm):
    ...
    def pokemon_db_sprite_url(self, is_shiny: bool, game: str, is_female=False) -> str:
        ...
        elif game == "black-white/anim" and (
    ...
    def bulbagarden_sprite_url(
        self, is_shiny: bool, game: str, is_female=False
    ) -> str | None:
        ...
        form_suffix = (
            ...
            and not (self.national_dex == 666 or self.national_dex == 671 or is_female)
            else forme_name
        )
        ...
        if self.regional:
            if self.regional != Regional.HISUI:
                ...
                if self.regional != Regional.ALOLA:
                    return False
        elif self.national_dex in HISUIAN_FORMS and self.national_dex != NatDex.SNEASEL:
            return False
    ...
    def has_home_sprite(self):
        return not (self.national_dex == NatDex.PICHU and self.form_index == SPIKY_EAR_PICHU)
