...
import { BW2SAV } from 'src/types/SAVTypes/BW2SAV'
import { BWSAV } from 'src/types/SAVTypes/BWSAV'
import { DPSAV } from 'src/types/SAVTypes/DPSAV'
import { G1SAV } from 'src/types/SAVTypes/G1SAV'
import { G2SAV } from 'src/types/SAVTypes/G2SAV'
import { G3SAV } from 'src/types/SAVTypes/G3SAV'
import { BDSPSAV } from 'src/types/SAVTypes/Gen89/BDSPSAV'
import { LASAV } from 'src/types/SAVTypes/Gen89/LASAV'
import { SVSAV } from 'src/types/SAVTypes/Gen89/SVSAV'
import { SwShSAV } from 'src/types/SAVTypes/Gen89/SwShSAV'
import { HGSSSAV } from 'src/types/SAVTypes/HGSSSAV'
import { LGPESAV } from 'src/types/SAVTypes/LGPESAV'
import { ORASSAV } from 'src/types/SAVTypes/ORASSAV'
import { PtSAV } from 'src/types/SAVTypes/PtSAV'
import { G3RRSAV } from 'src/types/SAVTypes/radicalred/G3RRSAV'
import { SMSAV } from 'src/types/SAVTypes/SMSAV'
import { G3UBSAV } from 'src/types/SAVTypes/unbound/G3UBSAV'
import { USUMSAV } from 'src/types/SAVTypes/USUMSAV'
import { SAVClass } from 'src/types/SAVTypes/util'
import { XYSAV } from 'src/types/SAVTypes/XYSAV'
