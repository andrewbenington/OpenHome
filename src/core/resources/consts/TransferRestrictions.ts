...
export const SWSH_TRANSFER_RESTRICTIONS_CT: TransferRestrictions = {
  transferableDexNums: [
    ...
    486, 487, 488, 494, 506, 507, 508, 509, 510, 517, 518, 519, 520, 521, 524, 525, 526, 527, 528,
    529, 530, 531, 532, 533, 534, 535, 536, 537, 538, 539, 543, 544, 545, 546, 547, 548, 549, 550,
    551, 552, 553, 554, 555, 556, 557, 558, 559, 560, 561, 562, 563, 564, 565, 566, 567, 568, 569,
    570, 571, 572, 573, 574, 575, 576, 577, 578, 579, 582, 583, 584, 587, 588, 589, 590, 591, 592,
    593, 595, 596, 597, 598, 599, 600, 601, 605, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615,
    616, 617, 618, 619, 620, 621, 622, 623, 624, 625, 626, 627, 628, 629, 630, 631, 632, 633, 634,
    635, 636, 637, 638, 639, 640, 641, 642, 643, 644, 645, 646, 647, 649, 659, 660, 661, 662, 663,
    674, 675, 677, 678, 679, 680, 681, 682, 683, 684, 685, 686, 687, 688, 689, 690, 691, 692, 693,
    694, 695, 696, 697, 698, 699, 700, 701, 702, 703, 704, 705, 706, 707, 708, 709, 710, 711, 712,
    713, 714, 715, 716, 717, 718, 719, 721, 722, 723, 724, 725, 726, 727, 728, 729, 730, 736, 737,
    738, 742, 743, 744, 745, 746, 747, 748, 749, 750, 751, 752, 753, 754, 755, 756, 757, 758, 759,
    760, 761, 762, 763, 764, 765, 766, 767, 768, 769, 770, 771, 772, 773, 776, 777, 778, 780, 781,
...
export const SV_TRANSFER_RESTRICTIONS_BASE: TransferRestrictions = {
  transferableDexNums: [
    ...
    453, 454, 456, 457, 459, 460, 461, 462, 470, 471, 475, 478, 479, 548, 549, 550, 551, 552, 553,
    570, 571, 574, 575, 576, 585, 586, 590, 591, 594, 602, 603, 604, 610, 611, 612, 613, 614, 615,
    624, 625, 627, 628, 633, 634, 635, 636, 637, 661, 662, 663, 664, 665, 666, 667, 668, 669, 670,
    671, 672, 673, 690, 691, 692, 693, 700, 701, 702, 704, 705, 706, 707, 712, 713, 714, 715, 734,
    735, 739, 740, 741, 744, 745, 747, 748, 749, 750, 753, 754, 757, 758, 761, 762, 763, 765, 766,
    769, 770, 775, 778, 779, 819, 820, 821, 822, 823, 833, 834, 837, 838, 839, 840, 841, 842, 843,
    844, 846, 847, 848, 849, 854, 855, 856, 857, 858, 859, 860, 861, 870, 871, 872, 873, 874, 875,
    876, 878, 879, 885, 886, 887, 906, 907, 908, 909, 910, 911, 912, 913, 914, 915, 916, 917, 918,
    ...
    995, 996, 997, 998, 999, 1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 4, 5,
    6, 144, 145, 146, 150, 151, 155, 156, 157, 195, 382, 383, 384, 480, 481, 482, 483, 484, 485,
    487, 488, 493, 501, 502, 503, 641, 642, 645, 648, 650, 651, 652, 653, 654, 655, 656, 657, 658,
    703, 719, 720, 721, 722, 723, 724, 801, 810, 811, 812, 813, 814, 815, 816, 817, 818, 863, 888,
    889, 890, 891, 892, 893, 894, 895, 896, 897, 898, 899, 900, 901, 902, 903, 904, 905, 1011, 1012,
    1013,
  ],
  excludedForms: {
    ...LgpeStarters,
...
export const SV_TRANSFER_RESTRICTIONS_TM: TransferRestrictions = {
  transferableDexNums: SV_TRANSFER_RESTRICTIONS_BASE.transferableDexNums?.concat([
    23, 24, 27, 28, 35, 36, 37, 38, 60, 61, 62, 69, 70, 71, 74, 75, 76, 109, 110, 143, 161, 162,
    167, 168, 163, 164, 173, 186, 190, 193, 207, 218, 219, 220, 221, 261, 262, 270, 271, 272, 273,
    274, 275, 299, 313, 314, 341, 342, 349, 350, 355, 356, 358, 385, 387, 388, 389, 390, 391, 392,
    393, 394, 395, 424, 433, 446, 469, 472, 473, 476, 477, 489, 490, 491, 492, 532, 533, 534, 540,
    541, 542, 580, 581, 607, 608, 609, 619, 620, 629, 630, 708, 709, 736, 737, 738, 742, 743, 782,
...
export const SV_TRANSFER_RESTRICTIONS_ID: TransferRestrictions = {
  transferableDexNums: SV_TRANSFER_RESTRICTIONS_TM.transferableDexNums?.concat([
    1, 2, 3, 7, 8, 9, 43, 44, 45, 72, 73, 84, 85, 86, 87, 102, 103, 106, 107, 111, 112, 116, 117,
    125, 126, 131, 137, 152, 153, 154, 158, 159, 160, 170, 171, 182, 209, 210, 227, 230, 233, 235,
    236, 237, 239, 240, 243, 244, 245, 249, 250, 252, 253, 254, 255, 256, 257, 258, 259, 260, 311,
    312, 328, 329, 330, 374, 375, 376, 377, 378, 379, 380, 381, 386, 408, 409, 410, 411, 464, 466,
    467, 474, 486, 495, 496, 497, 498, 499, 500, 522, 523, 529, 530, 546, 547, 559, 560, 572, 573,
    577, 578, 579, 595, 596, 622, 623, 638, 639, 640, 643, 644, 646, 647, 677, 678, 686, 687, 725,
    726, 727, 728, 729, 730, 731, 732, 733, 751, 752, 764, 774, 789, 790, 791, 792, 800, 868, 869,
...
export const ZA_TRANSFER_RESTRICTIONS_BASE: TransferRestrictions = {
  transferableDexNums: [
    152, 153, 154, 498, 499, 500, 158, 159, 160, 661, 662, 663, 659, 660, 664, 665, 666, 13, 14, 15,
...
export const ZA_TRANSFER_RESTRICTIONS_MD: TransferRestrictions = {
  transferableDexNums: ZA_TRANSFER_RESTRICTIONS_BASE.transferableDexNums?.concat([
    56, 57, 979, 52, 53, 863, 83, 865, 104, 105, 137, 233, 474, 951, 952, 957, 958, 959, 967, 969,
...
export const CHAMPS_TRANSFER_RESTRICTIONS: TransferRestrictions = {
  transferableDexNums: [
    ...
    952, 956, 959, 964, 968, 970, 972, 979, 981, 983, 1000, 1013, 1018, 1019,
  ],
  excludedForms: {
    ...CapAndStarterPikachus,
    [NationalDex.Qwilfish]: [HISUI],
    [NationalDex.Absol]: [MEGA_Z],
    [NationalDex.Garchomp]: [MEGA_Z],
    [NationalDex.Lucario]: [MEGA_Z],
    [NationalDex.Greninja]: [GRENINJA_ASH],
