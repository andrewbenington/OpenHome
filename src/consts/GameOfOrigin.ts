...
export const GameOfOriginData: (Origin | null)[] = [
  ...
  { name: 'GO', mark: 'GO' },
  { name: 'Red', mark: 'GB' },
  { name: 'Blue/Green', mark: 'GB', logo: 'BlueGreen' },
  { name: 'Blue (Japan)', mark: 'GB', logo: 'BlueJP' },
  { name: 'Yellow', mark: 'GB' },
  { name: 'Gold', mark: 'GB' },
  { name: 'Silver', mark: 'GB' },
  { name: 'Crystal', mark: 'GB' },
  { name: "Let's Go, Pikachu!", mark: 'LGPE', logo: "LetsGoPikachu" },
  { name: "Let's Go, Eevee!", mark: 'LGPE', logo: "LetsGoEevee" },
  { name: 'Sword', mark: 'Galar' },
  { name: 'Shield', mark: 'Galar' },
  null,
  { name: 'Legends: Arceus', mark: 'LA', logo: 'LegendsArceus' },
