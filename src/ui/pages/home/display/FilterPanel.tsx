    ...
    <div className="filter-panel">
      ...
      <div className="filter-fields-scroller">
        ...
        <Typeahead
          ...
          getIconComponent={(type) => <TypeIcon size={ICON_SIZE} type={type} />}
          placeholder="Type 1"
        />
        {filter.type1 && (
          <Typeahead
        ...
        <Typeahead
          ...
          getIconComponent={(opt) => <GenderIcon size={ICON_SIZE} gender={opt.gender} />}
        />
        <Typeahead
          uniqueFieldId="ribbons"
