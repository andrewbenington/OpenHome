...
type Filters<T extends Record<string, unknown>> = Partial<{
  [K in keyof T]: string[]
}>

type CustomDataGridProps<R extends Record<string, unknown>> = {
...
export default function CustomDataGrid<R extends Record<string, unknown>>(
  ...
  const baseRowHeight = rowHeight ?? 20
