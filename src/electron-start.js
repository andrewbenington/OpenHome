...
ipcMain.handle("read-home-data", () => {
  console.log("read-home-data")
  const appDataPath = app.getPath("appData");
  if (!fs.existsSync(appDataPath + "/open-home/storage/boxes")) {
    _.range(24).forEach(boxNum => fs.mkdirSync(appDataPath + `/open-home/storage/boxes/box${boxNum.toString().padStart(2, "0")}`, { recursive: true }))
  }
